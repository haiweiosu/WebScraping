#Second demo for web scraoing
#Credited from: http://www.gregreda.com/2013/04/29/more-web-scraping-with-python/
...
with open("data/src-best-sandwiches.tsv", "w") as f:
    ...
    for url in sammy_urls:
        ...
        rank = soup.find("div", {"id": "sandRank"}).encode_contents().strip()  soup = BeautifulSoup(page.read()).find("div", {"id": "sandwich"})
